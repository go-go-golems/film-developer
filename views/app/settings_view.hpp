...
public:
    ...
    void init() override {
        ...
        push_pull_item =
            add_item("Push/Pull", MainViewModel::PUSH_PULL_COUNT, push_pull_change_callback, this);
        ...
        roll_count_item = add_item(
            "Roll Count", MainViewModel::MAX_ROLL_COUNT, roll_count_change_callback, this);
